  ...
  return (
    <div
      ...
      className={`flex items-center gap-2 group
        ${hasError ? "ring-1 ring-red-500/40 rounded-md px-1" : ""}
      `}
    >
      {/* drag handle */}
      <button
        ...
        {...listeners}
        id={reactId}
        className="text-border hover:text-text-faint cursor-grab active:cursor-grabbing opacity-0 group-hover:opacity-100 transition-opacity"
      ...
      <Button
        ...
        className="w-6 h-6 opacity-0 group-hover:opacity-100 transition-opacity text-text-faint hover:text-red-400"
